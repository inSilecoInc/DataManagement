...
- The **explosion & heterogeneity** of data offers new horizons and creates new technical challenges  
...
- Policies matter: **Tri-Agency RDM Policy** (national) and hopefully internal policies
...
- **Tools & platforms** ➡️ Borealis, FRDR, ISA tools  
- **Timing** ➡️ start at project onset, update regularly, finalize at archiving  
- **Interoperability** ➡️ controlled vocabularies, ontologies
:::
...
- **Trusted repositories** ➡️ FRDR, Borealis, Dryad, Zenodo, GBIF, OBIS
